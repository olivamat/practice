...
gulp.task('watch', function () {
    ...
    gulp.watch('./src/js_dep/*.js', ['js_dep']);
});
...
gulp.task("start",["clean:build","html", "js", "sass","css","svg","bundleImg","bundleFonts", "js_dep", "webServer", "watch"]);
